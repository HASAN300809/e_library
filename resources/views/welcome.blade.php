...
<body class="bg-gradient-to-r from-blue-100 to-indigo-100 font-sans">
  ...
  <section class="text-center py-20 px-6 bg-gradient-to-r from-sky-100 to-blue-100">
    <h2 class="text-4xl md:text-5xl font-bold text-gray-800 mb-6">Selamat Datang di <span class="text-blue-600">My E-Library</span></h2>
  ...
  <section class="py-16 bg-white text-center">
    <h3 class="text-3xl font-semibold text-gray-800 mb-10">Kenapa Memilih My E-Library?</h3>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
      <div class="p-6 bg-yellow-50 rounded shadow hover:shadow-lg">
        <h4 class="text-xl font-bold text-blue-600 mb-2">📚 Koleksi Lengkap</h4>
        <p class="text-gray-600">Dari fiksi hingga ilmiah, semua tersedia di satu tempat.</p>
      </div>
      <div class="p-6 bg-yellow-50 rounded shadow hover:shadow-lg">
        <h4 class="text-xl font-bold text-blue-600 mb-2">⚡ Akses Cepat</h4>
        <p class="text-gray-600">Cari dan baca buku favoritmu tanpa ribet.</p>
      </div>
      <div class="p-6 bg-yellow-50 rounded shadow hover:shadow-lg">
        <h4 class="text-xl font-bold text-blue-600 mb-2">🌐 Bisa Diakses Kapan Saja</h4>
